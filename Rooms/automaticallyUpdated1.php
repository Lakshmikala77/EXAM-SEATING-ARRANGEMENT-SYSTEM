...
$sql1 = mysqli_query($conn,"SELECT COUNT(classroom) AS classroom FROM trisub1 ");
...
while ($result = mysqli_fetch_assoc($sql)) {
  ...
  elseif ($i <= 390) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub1 values('$year', '$dept', '$rlnum', 'seminarhall-A', '$subject', '$examdate', '$starttime', '$endtime','$mail')");
    $i++;
  }
      elseif ($i <= 420) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub1 values('$year', '$dept', '$rlnum', 'seminarhall-B', '$subject', '$examdate', '$starttime', '$endtime','$mail')");
    $i++;
  }
  /**elseif ($i <= 450) {
    # code...
...
<head>
  ...
  <title>Automatic allottement Bblock</title>

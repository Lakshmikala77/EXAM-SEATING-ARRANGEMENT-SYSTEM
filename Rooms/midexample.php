...
<body>
<a href="RoomNo-A31.php" class="btn  btn-sm"><span class="glyphicon glyphicon-chevron-left"></span>back</a>
...
<div>
    <table class="Room-table">
      ...
      <?php
      $numq1="SELECT  enrollnumber,department from trisub where classroom='$room' ";

...
$sql1 = mysqli_query($conn,"SELECT COUNT(classroom) AS classroom FROM trisub WHERE classroom = '$room' ");
...
if ($count == 30) {
  ...
  ?>
    <script type="text/javascript">
        ...
        setTimeout(function(){
        window.location.href = "../Ablock.php";
        },0);
    </script>
...
while ($result = mysqli_fetch_assoc($sql)) {
  ...
  if ($i <= 30) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', '$room', '$subject', '$examdate', '$starttime', '$endtime','$email')");
    $i++;
  }

...
if (isset($_POST['schedule'])) {
  ...
  $branch =mysqli_query($conn, "SELECT Distinct examdate , starttime, endtime FROM trisub1 Where classroom = '$room'");
...
<body>
  ...
  <a  href="automaticallyUpdated1.php">Automatic allotement</a>
  <a href="extallotment1.php">External Allotment</a>
  <a class="active" href="asignfaculty1.php">Allot Invigilators</a>
</div>
  <br>
  <div class="form_block">
            ...
            ?>
                ...
                <div class="form-group col-md-6">
                  ...
                  <option></option>
               <?php
                $sql1=mysqli_query($conn, "SELECT distinct classroom from trisub1 WHERE classroom NOT IN(select room from invigallot)");

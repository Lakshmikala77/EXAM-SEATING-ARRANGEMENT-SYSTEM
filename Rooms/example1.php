...
<center><h2 class="table">Room_NO-<?php echo($room)?></h2></center>
 ...
 <div>
   <table class="Room-table">
      ...
      <?php
      $branchq1=mysqli_query($conn, "SELECT distinct department from trisub1 where classroom='$room'");
      $res = mysqli_fetch_assoc($branchq1);
      $brnh = $res['department'];
      $numq1="SELECT  enrollnumber,department from trisub1 where classroom='$room' AND department = '$brnh' ";
      $numq2="SELECT  enrollnumber,department from trisub1 where classroom='$room' And department != '$brnh'";

...
if (isset($_POST['schedule'])) {
  ...
  $branch =mysqli_query($conn, "SELECT Distinct examdate , starttime, endtime FROM trisub2 Where classroom = '$room'");
  ...
  <div class="form_block">
            ...
            ?>
                ...
                <div class="form-group col-md-6">
                  ...
                  <option></option>
               <?php
                $sql1=mysqli_query($conn, "SELECT distinct classroom from trisub2 WHERE classroom NOT IN(select room from invigallot)");

...
$sql1 = mysqli_query($conn,"SELECT COUNT(classroom) AS classroom FROM trisub where department = '$dept' ");
$res = mysqli_fetch_assoc($sql1);
$count = $res['classroom'];

$sql2 = mysqli_query($conn,"SELECT COUNT(department) AS department FROM trisub WHERE department = '$dept' ");
...
/*elseif ($count1 <= 194) {
    ...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', 'computerLab1', '$subject', '$examdate', '$starttime', '$endtime','$mail')");
    $i++;
    $count1++;
    }
  }
...
<body>
  ...
  <div class="container">
    ...
    <div>
      ...
      <div class="topnav">
  <a href="../Ablockexter.php">Home</a>
  <!--a href="automaticallyUpdated.php">Automatic allotement</a-->
  <a class="active" href="extallotment.php">External Allotment</a>
  <a href="asignfaculty.php">Allot Invigilators</a>
  <!--a href="#individua">individual Room </a-->
</div>
<br/>

...
$sql1 = mysqli_query($conn,"SELECT COUNT(classroom) AS classroom FROM trisub2");
...
while ($result = mysqli_fetch_assoc($sql)) {
 ...
 /* elseif ($i <= 390) {
    # code...
  //  mysqli_query($conn,"INSERT INTO trisub2 values('$year', '$dept', '$rlnum', 'computerLab2', '$subject', '$examdate', '$starttime', '$endtime','$mail')");
    $i++;
  }
      elseif ($i <= 420) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub2 values('$year', '$dept', '$rlnum', 'apssdclab', '$subject', '$examdate', '$starttime', '$endtime','$mail')");
    $i++;
  }*/
  elseif ($i <= 390) {
    # code...
    mysqli_query($conn,"INSERT INTO trisub2 values('$year', '$dept', '$rlnum', 'seminarhall', '$subject', '$examdate', '$starttime', '$endtime','$mail')");
    $i++;
  }
  elseif ($i <= 420) {
    # code...
...
<body>
  ...
  <div class="container">
    ...
    <div>
      ...
      <div class="topnav">
  <a href="../mainblock.php">Home</a>
  <a class="active" href="automaticallyUpdated2.php">Automatic allotement</a>
  <!--a href="extallotment2.php">External Allotment</a>-->
